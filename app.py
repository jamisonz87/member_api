...
def protected(f):
    ...
    def decorated(*args, **kwargs):
        ...
        return jsonify({'message' : 'Authentication failed'}), 403 # Auth Failed
    return decorated
...
def edit_member(member_id):
    ...
    return jsonify({'Member Updated:':{'id':member['id'],'name':member['name'],'email':member['email'],'level':member['level']}})
